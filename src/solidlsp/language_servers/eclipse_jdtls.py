    ...
    class DependencyProvider(LanguageServerDependencyProvider):
        ...
        def _setup_runtime_dependencies(cls, ls_resources_dir: str) -> RuntimeDependencyPaths:
            ...
            runtime_dependencies = {
                ...
                "vscode-java": {
                    "darwin-arm64": {
                        "url": "https://github.com/redhat-developer/vscode-java/releases/download/v1.53.0/java-darwin-arm64-1.53.0-873.vsix",
                        "archiveType": "zip",
                    ...
                    "osx-x64": {
                        "url": "https://github.com/redhat-developer/vscode-java/releases/download/v1.53.0/java-darwin-x64-1.53.0-873.vsix",
                        "archiveType": "zip",
                        "relative_extraction_path": "vscode-java",
                    ...
                    "linux-arm64": {
                        "url": "https://github.com/redhat-developer/vscode-java/releases/download/v1.53.0/java-linux-arm64-1.53.0-873.vsix",
                        "archiveType": "zip",
                        "relative_extraction_path": "vscode-java",
                    ...
                    "linux-x64": {
                        "url": "https://github.com/redhat-developer/vscode-java/releases/download/v1.53.0/java-linux-x64-1.53.0-873.vsix",
                        "archiveType": "zip",
                        "relative_extraction_path": "vscode-java",
                    ...
                    "win-x64": {
                        "url": "https://github.com/redhat-developer/vscode-java/releases/download/v1.53.0/java-win32-x64-1.53.0-873.vsix",
                        "archiveType": "zip",
                        "relative_extraction_path": "vscode-java",
